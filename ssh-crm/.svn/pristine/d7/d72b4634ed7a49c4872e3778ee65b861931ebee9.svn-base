...
<script type="text/javascript">
	...
	//点击提交提交到了CustomerAction中的Customer对象中，而Customer对象中又有BaseDict对象
		loadSelect("006","level","cust_level.dict_id" <s:if test="#customer.cust_level.dict_id!=null">,<s:property value="#customer.cust_level.dict_id"/></s:if>);
		loadSelect("001","industry","cust_industry.dict_id" <s:if test="#customer.cust_industry.dict_id!=null">,<s:property value="#customer.cust_industry.dict_id"/></s:if>);
		loadSelect("009","source","cust_source.dict_id" <s:if test="#customer.cust_source.dict_id!=null">,<s:property value="#customer.cust_source.dict_id"/></s:if>);
...
<!-- 文件上传页面3个要求：
 ...
 -->
	<FORM id=form1 name=form1
		...
		<!-- 隐藏域对象（用于保存customer的id，上传到后台以便使用saveOrUpdate方法执行保存或更新） -->
