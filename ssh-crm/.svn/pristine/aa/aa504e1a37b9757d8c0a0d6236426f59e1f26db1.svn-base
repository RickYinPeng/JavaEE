											...
											<TBODY>
												<TR>
													...
													<TD>
														...
														<INPUT class=textbox 
															style="WIDTH: 80px" maxLength=50  id="cust_name" name="customer.cust_name" value="${param['customer.cust_name']}"/>
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												到
												<input id ="page" type="text" size="3" id="page" name="page" value="<s:property value="#pageBean.currentPage"/>"/>
												页
