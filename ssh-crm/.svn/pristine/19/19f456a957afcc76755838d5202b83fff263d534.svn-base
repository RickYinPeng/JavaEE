				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>当前位置：联系人管理 &gt; <s:property value="#linkMan==null?'添加':'修改'"/>联系人联系人</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>联系人性别：</td>
								<td>
								<input type="radio" value="1" name="lkm_gender" checked=<s:property value="#linkMan.lkm_gender==1?'checked':''"/>>男
								<input type="radio" value="2" name="lkm_gender" checked=<s:property value="#linkMan.lkm_gender==2?'checked':''"/>>女
								</td>
							</TR>
							<TR>
								<td>联系人办公电话 ：</td>
